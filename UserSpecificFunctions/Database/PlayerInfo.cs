...
namespace UserSpecificFunctions.Database
{
    ...
    public sealed class PlayerInfo
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="PlayerInfo" /> class with the specified user ID, chat data and
        ///     permissions.
        /// </summary>
        /// <param name="userId">The user ID.</param>
        /// <param name="chatData">The user's chat information, which may not be null.</param>
        /// <param name="permissions">A collection of the user's permissions, which may not be null.</param>
        public PlayerInfo(int userId, [NotNull] ChatData chatData, [NotNull] PermissionCollection permissions) : this(
            userId, chatData)
        {
